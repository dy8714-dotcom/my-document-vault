...
// 第2段階：ラベル用カラーパレット（プリセット）
const LABEL_COLOR_PRESETS = [
  { bg: "#EEEDFE", border: "#7F77DD", text: "#3C3489" },  // 紫
  { bg: "#E1F5EE", border: "#1D9E75", text: "#085041" },  // 緑
  { bg: "#FBEAF0", border: "#D4537E", text: "#72243E" },  // ピンク
  { bg: "#FAEEDA", border: "#BA7517", text: "#633806" },  // オレンジ
  { bg: "#DBEEFB", border: "#378ADD", text: "#0C447C" },  // 青
  { bg: "#FCEBEB", border: "#E24B4A", text: "#7F1A1A" },  // 赤
  { bg: "#FFF8C5", border: "#D4A72C", text: "#5C4112" },  // 黄
  { bg: "#E8E5DA", border: "#888780", text: "#3F3E3D" },  // グレー
  { bg: "#E1F4F4", border: "#1A9EA0", text: "#0A4F50" },  // ターコイズ
  { bg: "#F4DDF6", border: "#A347B5", text: "#5C2068" }   // マゼンタ
];
